...
namespace jeanvaljean\Timezone\Middleware;
 ...
 */
class TimezoneMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        */
        if ($request->getSession()->read('Auth.timezone')) {
            $timezone = $request->getSession()->read('Auth.timezone');
        }
