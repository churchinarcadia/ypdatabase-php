...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            <?php
                if (
                    $permissions['meeting_location']['add'] ||
                ...
                if ($permissions['meeting_location'][$meetingLocation->id]['can']['edit']) {
                    echo $this->Html->link(__('Edit Meeting Location'), ['action' => 'edit', $meetingLocation->id], ['class' => 'side-nav-item']);
                }
                if ($permissions['meeting_location'][$meetingLocation->id]['can']['delete']) {
                    echo $this->Form->postLink(__('Delete Meeting Location'), ['action' => 'delete', $meetingLocation->id], ['confirm' => __('Are you sure you want to delete # {0}?', $meetingLocation->id), 'class' => 'side-nav-item']);
                }
                if (true) {
                    echo $this->Html->link(__('List Meeting Locations'), ['action' => 'index'], ['class' => 'side-nav-item']);
                }
                if ($permissions['meeting_location']['add']) {
                    echo $this->Html->link(__('New Meeting Location'), ['action' => 'add'], ['class' => 'side-nav-item']);
                }
            ?>
        </div>
    </aside>
